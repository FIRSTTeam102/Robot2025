...
public class RobotContainer
{
  ...
  //Enable robotRelative driving if the right trigger is pressed.
    ...
    // shuffleboard
    //driverXbox.a().whileTrue(drivebase.alignToReefScore(17,TargetSide.LEFT),drivebase);
    //driverXbox.b().whileTrue(drivebase.alignToReefScore(18,TargetSide.RIGHT),drivebase);
